...
public class BACHandler {
    ...
    public func performBACAndGetSessionKeys( mrzKey : String, completed: @escaping (_ error : NFCSDKError?)->() ) {
        ...
        do {
            ...
            completed( NFCSDKError.InvalidDataPassed("Unable to derive BAC Keys - \(error.localizedDescription)") )
            return
